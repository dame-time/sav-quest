...
export const Toggle = ({ selected, setSelected }) => {
  return (
    <div className="relative mx-auto mt-3 flex w-fit items-center rounded-full bg-background">
      <button
      ...
      >
        <motion.span
          ...
          className="h-full w-1/2 rounded-full border border-border bg-foreground"
        />
      </div>
    </div>
  );
