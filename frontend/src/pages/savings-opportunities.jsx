...
import { Box, Container, Typography, Slider, Grid, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Card, CardContent, Divider, CircularProgress, Alert, TextField } from '@mui/material';
...
export default function SaveMore() {
  ...
  useEffect(() => {
    const fetchInsights = async () => {
      ...
      setError(null);
      try {
        const response = await axios.get(`${process.env.REACT_APP_API_URL || 'http://localhost:8000'}/api/v1/savings-opportunities/insights`, {
          params: {
              ...
              <div>
                ...
                <div className="relative mt-2 rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    className="block w-full rounded-md border-zinc-700 bg-zinc-800 pl-7 pr-12 text-white focus:border-indigo-500 focus:ring-indigo-500"
                    placeholder="0.00"
                  />
                </div>
              </div>
